...
| 演示页清单 | 自动列出 docs/demo 全部页面（主仓 12 页），含"打开 / 手机壳"双入口 |
| 手机壳容器 | `shell.html?page=hotel-owner-app.html` 套 iPhone 壳（390×872）渲染无破版 |
| 案例页 | `hotel-owner-app.html`（店主端）/ `service-front-b-mobile.html` 数据饱满 |
