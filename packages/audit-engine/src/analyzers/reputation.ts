/**
 * 酒店运营线·口碑存量（fast-scan SKILL.md 步骤 4）
 * 三个子项：
 *  1) 差评（≤3 分，R6 口径）>24h 未回复（R19 酒店 SLA；>72h 升 P0——舆情已发酵）
 *  2) 评分 <4.2 且近30天评分下滑 >0.3（门店档案指标；未采集则跳过，engine 标 partial）
 *  3) 差评关键词聚集：近30天差评中同关键词 ≥3 条（卫生/隔音/热水/前台/早餐/空调/异味/安全；
 *     「安全」类聚集升 P0）——聚集关键词同时产出给 intent-radar 作选题矿源
 */
