...
version: 1.2
description: 行业标杆竞品深度调研方法论。针对某一行业中已跑出被验证产品模式/范式的标杆企业或产品，进行全量深度拆解，输出可指导HyperReality行业落地的竞品脑暴文档。覆盖产品定位、功能模块、技术架构、客群定价、差异化竞争、行业趋势六大维度。属于HyperReality进入新行业的"知己知彼"元技能，在行业Bundle开发前调用。
---
...
这个技能就是回答这个问题的"元方法论"。它不是调研某个具体竞品的功能列表，而是**拆解一个标杆企业从"产品定位"到"战略逻辑"的完整骨架**，找出其被市场验证的模式本质，并识别HyperReality可以切入的差异化空间。
...
**场景一：新行业进入调研**
HyperReality决定进入餐饮行业，需要找到餐饮SaaS/AI领域的标杆玩家（如美团SaaS、客如云、哗啦啦等），深度拆解其产品模式，找出HyperReality的差异化机会。

**场景二：标杆产品范式跃迁追踪**
酒店行业的订单来了从"PMS厂商"跃迁为"AI操作系统厂商"，这种范式跃迁值得深度拆解——它为什么转型？转型后的产品架构是什么？对HyperReality有什么启示？

**场景三：竞争格局变化评估**
行业内出现新的强力竞争者（如通用AI巨头进入），需要重新评估竞争格局，调整HyperReality的差异化定位。
...
4. **与HyperReality架构对比**：每个关键设计，与HyperReality的对应机制对比（如"唯一事实源"对应HyperReality的"五元事件库"）。
...
3. **与HyperReality目标客群的对比**：重叠区域在哪里？各自独占的客群在哪里？
4. **定价体系分析**：版本划分、价格区间、功能范围、目标客群。AI功能的定价模式推测。
5. **对HyperReality定价的启示**：HyperReality可以采用什么差异化定价模式？
...
**拆解步骤**：
1. **多维度系统对比**：从底座、自治能力、夜班能力、审计能力、围栏精细度、生态模式、定价模式等维度，系统对比标杆企业与HyperReality。
2. **标杆企业的优势识别**：它在哪些方面有先发优势？（HyperReality需补齐什么？）
3. **HyperReality的潜在优势识别**：HyperReality在哪些方面有差异化优势？（标杆企业尚未覆盖什么？）
4. **差异化竞争策略建议**：基于以上分析，HyperReality应采取什么差异化竞争策略？（通常3-5条）
...
5. **对HyperReality的战略启示**：基于趋势判断，HyperReality应采取什么战略？（通常3-5条启示）
...
2. **第一章：产品定位与核心卖点拆解**
3. **第二章：功能模块深度拆解**
4. **第三章：技术架构推测 + 目标客群与定价策略 + 与HyperReality差异化竞争点**
5. **第四章：行业趋势判断**
