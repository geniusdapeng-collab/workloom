...
export default function P7() {
  ...
  const [draft, setDraft] = useState({
    ...
    fenceRef: "ai-video-baseline/v1", ownerMemberNo: "", // 打开向导时以当前登录身份填充
  });
  ...
  const submitDraft = useCallback(async () => {
    ...
    try {
      ...
      setDraft({ slug: "", displayName: "", version: "0.1.0", changelog: "", fenceRef: "ai-video-baseline/v1", ownerMemberNo: "" });
