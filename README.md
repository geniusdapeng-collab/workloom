...
> **这是什么**：一套面向 B 端商家的 **AI 获客经营系统**。以「短视频社媒营销 + GEO（生成式引擎优化）」双引擎触达客户，以「获客五环」（意图洞察→双域触达→四路承接→线索转化→归因复盘）闭环经营，每一环都可度量到钱。首个深度垂直行业是**酒店**（社媒营销 × GEO × 获客 × 酒店运营一体），底座支持向各行业复制 Bundle。
